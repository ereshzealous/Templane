// Package core defines the Templane data model and core operations.
package core
...
func (t TemplaneFieldType) MarshalJSON() ([]byte, error) {
	...
	case "object":
		if t.Fields == nil {
			m["fields"] = map[string]TemplaneField{}
		} else {
			m["fields"] = t.Fields
		}
	}
...
func (t *TemplaneFieldType) UnmarshalJSON(data []byte) error {
	var env struct {
		Kind     string              `json:"kind"`
		Values   []string            `json:"values"`
		ItemType *TemplaneFieldType       `json:"item_type"`
		Fields   map[string]TemplaneField `json:"fields"`
	}
