...
public final class TypeChecker {
    ...
    public static List<TypeCheckError> check(TypedSchema schema, Map<String, Object> data, String prefix) {
        ...
        for (Map.Entry<String, TemplaneField> e : schema.fields().entrySet()) {
            String name = e.getKey();
            TemplaneField field = e.getValue();
    ...
    private static List<TypeCheckError> checkType(TemplaneFieldType type, Object value, String path) {
        List<TypeCheckError> errors = new ArrayList<>();
        switch (type) {
            case StringType s -> {
